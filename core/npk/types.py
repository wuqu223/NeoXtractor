...
class NPKIndex:
    ...
    def __init__(self):
        self.file_sign: Union[int, List[int]] = 0
        self.file_offset: int = 0
        self.file_length: int = 0
        self.file_original_length: int = 0
        self.zcrc: int = 0  # compressed CRC
        self.crc: int = 0   # decompressed CRC
        self.file_structure: bytes | None = None
        self.zip_flag: CompressionType = CompressionType.NONE
        self.encrypt_flag: DecryptionType = DecryptionType.NONE
